 ...
 */
     ...
     * 
     *
     * @method static \Illuminate\Database\Query\Builder dtable(string $table, string $as = null)
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function sharedPricingCalculatorsColumns()
        {
                        return \Illuminate\Database\Schema\Blueprint::sharedPricingCalculatorsColumns();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function sharedPercentageWithCostColumns()
        {
                        return \Illuminate\Database\Schema\Blueprint::sharedPercentageWithCostColumns();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function sharedCostColumns()
        {
                        return \Illuminate\Database\Schema\Blueprint::sharedCostColumns();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function sharedPercentageColumns()
        {
                        return \Illuminate\Database\Schema\Blueprint::sharedPercentageColumns();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function sharedColumns()
        {
                        return \Illuminate\Database\Schema\Blueprint::sharedColumns();
        }
