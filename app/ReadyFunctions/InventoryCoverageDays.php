	...
	public function calculateForIntervals(array $items,array $dateIndexWithDate,HospitalitySector $hospitalitySector,bool $convertIndexesToNames=false)
	{
		...
		foreach($items as $directExpenseIdentifier => $item)
		{
			...
			$purchasesForInterval = [
				'monthly'=>$purchases,
				'quarterly'=>sumIntervalsIndexes($purchases,'quarterly' , $hospitalitySector->financialYearStartMonth(),$dateIndexWithDate),
				'semi-annually'=>sumIntervalsIndexes($purchases,'semi-annually' , $hospitalitySector->financialYearStartMonth(),$dateIndexWithDate),
				'annually'=>sumIntervalsIndexes($purchases,'annually' , $hospitalitySector->financialYearStartMonth(),$dateIndexWithDate),
			];
			
			$dispensedDisposableCostForInterval = [
				'monthly'=>$dispensedDisposableCost,
				'quarterly'=>sumIntervalsIndexes($dispensedDisposableCost,'quarterly' , $hospitalitySector->financialYearStartMonth(),$dateIndexWithDate),
				'semi-annually'=>sumIntervalsIndexes($dispensedDisposableCost,'semi-annually' , $hospitalitySector->financialYearStartMonth(),$dateIndexWithDate),
				'annually'=>sumIntervalsIndexes($dispensedDisposableCost,'annually' , $hospitalitySector->financialYearStartMonth(),$dateIndexWithDate),
			];
