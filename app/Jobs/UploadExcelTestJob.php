...
class UploadExcelTestJob implements ShouldQueue
{
    ...
    public function handle()
    {
        CachingCompany::where('company_id' , $this->company_id )->get()->each(function($cachingCompany){
            ...
            {
                DB::table('upload_excels')->insert($chunk);
                $key = getTotalUploadForUploadExcelCacheKey($this->company_id , $cachingCompany->job_id) ;
