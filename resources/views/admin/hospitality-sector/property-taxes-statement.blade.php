...
<x-main-form-title :id="'main-form-title'" :class="''">{{ __('Property Taxes Statement Report') .' - '. $hospitalitySector->getStudyName() . ' - ' . $hospitalitySector->getPropertyName() }}</x-main-form-title>
