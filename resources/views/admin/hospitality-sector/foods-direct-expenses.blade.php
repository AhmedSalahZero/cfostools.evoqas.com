...
@endsection
@section('sub-header')
<x-main-form-title :id="'main-form-title'" :class="''">{{ __('Foods & Beverage Department Expenses Projection Input Sheet') }}</x-main-form-title>
                        ...
                        <div class="col-md-10">
                            <div class="d-flex align-items-center ">
                                <h3 class="font-weight-bold form-label kt-subheader__title small-caps mr-5" style="">
                                    {{ __('Variable Expenses As % From Foods & Beverage Revenues') }}
                                </h3>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="vertical-align:middle;text-transform:capitalize;text-align:left">
                                        <b>
                                            {{ __('Total F&B Facility Revenues') }}
                                        </b>
                                    </td>
                                ...
                                @for($instance = 0 ; $instance<5 ; $instance++) @php $directExpense=$model->getDirectExpenseForSection($modelName,$currentSectionName , $instance);
                                    ...
                                    <tr>
                                            ...
                                            <div class="form-group three-dots-parent">
                                                <div class="input-group input-group-sm align-items-center justify-content-center div-for-percentage">
                                                    <select name="chosen_guest_expense_currency[{{ $currentSectionName }}][{{ $instance }}]" data-order="{{ $order }}" class="form-control ">
                                                        ...
                                                        <option value="{{ $currencyId }}" @if($currencyId==($directExpense ? $directExpense->getGuestExpenseChosenCurrency() : 0) )
                                                            selected
                                                            @endif
                                                            >{{ $currencyName }}</option>
                                                        @endforeach
                                        ...
                                        <td style="vertical-align:middle;text-transform:capitalize;text-align:center">
                                            <input data-calc-adr-operating-date data-id="{{ $instance  }}" style="max-width:80px;margin-left:auto;margin-right:auto" type="text" step="0.1" class="avg-daily-rate form-control only-greater-than-or-equal-zero-allowed" value="{{ $directExpense ? number_format($directExpense->getExpensePerGuestSold()):0 }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group three-dots-parent">
                                                <div class="input-group input-group-sm align-items-center justify-content-center div-for-percentage">
                                                    {{-- <input type="hidden"   class="target_repeating_values  " value="0"> --}}
                                                    <input data-calc-adr-operating-date type="text" style="max-width: 100px;min-width: 80px;text-align: center" value="{{ number_format($directExpense ? $directExpense->getGuestExpenseEscalationRate() : 0 ) }}" data-order="{{ $order }}" data-index="{{ $instance }}" onchange="this.style.width = ((this.value.length + 1) * 10) + 'px';" step="0.1" data-id="{{ $instance }}" class="form-control target_repeating_amounts only-percentage-allowed size ">
                                                    <input type="hidden" class="adr-escalation-rate cover-value-escalation-rate" name="guest_expense_escalation_rate[{{ $currentSectionName }}][{{ $instance }}]" data-id="{{ $instance}}" value="{{ $directExpense ? $directExpense->getGuestExpenseEscalationRate():0 }}" data-order="{{ $order }}" data-index="{{ $instance }}">
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align:middle;text-transform:capitalize;text-align:center">
                                            <select class="form-control" name="inventory_coverage_days[{{ $currentSectionName }}][{{ $instance }}]">
                                                ...
                                                <option value="{{ $coverageDay }}" @if($coverageDay==$inventoryCoverageDays) selected @endif> {{ $coverageDay }} </option>
                                                @endforeach
                                            </select>
                                        </td>
