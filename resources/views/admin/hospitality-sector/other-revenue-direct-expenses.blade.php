...
@endsection
@section('sub-header')
<x-main-form-title :id="'main-form-title'" :class="''">{{ __('Other Revenues Expenses Projection Input Sheet') }}</x-main-form-title>
									...
									<div class="col-md-10">
										<div class="d-flex align-items-center ">
											<h3 class="font-weight-bold form-label kt-subheader__title small-caps mr-5" style="">
												{{ __('Variable Expenses As % From Other Revenues') }}
											</h3>
										</div>
									</div>
									<div class="col-md-2">
										...
										<tbody>
											...
											<tr>
												<td style="vertical-align:middle;text-transform:capitalize;text-align:left">
													<b>
														{{ __('Total Other Revenues Facility Revenues') }}
													</b>
												</td>
												...
												<td>
													...
													<div class="form-group three-dots-parent">
														...
														<div class="input-group input-group-sm align-items-center justify-content-center div-for-percentage">
															<input type="text" style="text-align: center" value="{{ number_format($otherRevenueFacilityRevenue['totalOfEachYear'][$year]??0 , 0) }}" readonly onchange="this.style.width = ((this.value.length + 1) * 10) + 'px';" class="form-control size trigger-change-when-start">
															<span class="ml-2">
