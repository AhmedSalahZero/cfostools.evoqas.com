            ...
            <div class="row">
                ...
                <div class="col-md-4 item-main-parent">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <input type="number" step="1" min="1" id="duration" name="duration" value="{{ @old('duration') }}" class="form-control number  grace-period-class grace_period_calc max-tenor-limit installment_condition" placeholder="{{__('Duration In Months')}} .." required />
