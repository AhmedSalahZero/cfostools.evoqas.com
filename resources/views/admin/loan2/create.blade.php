                ...
                <div class="col-md-4 item-main-parent">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            ...
                            type="number" step="1" min="1" max="600" id="duration" name="duration"  class="form-control number grace-period-class grace_period_calc max-tenor-limit installment_condition" placeholder="{{__('Duration In Months')}} .." required />
                ...
                <div class="col-md-4 item-main-parent" style="display: none">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            ...
                            type="text" step="any" id="grace_periodid" name="grace_period" class="form-control number grace-period-class grace-period-class grace_period_calc installment_condition" placeholder="{{__('Grace Period')}} .." />
