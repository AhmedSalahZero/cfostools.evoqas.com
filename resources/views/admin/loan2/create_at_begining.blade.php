            ...
            <div class="row">
                ...
                <div class="col-md-4" id="view_grace_period">
                    <div class="form-group validated">
                        ...
                        <div class="form-group-sub">
                            <input type="text" step="any" id="grace_periodid" name="grace_period" value="{{ @old('grace_period') }}" class="form-control number grace-period-class grace_period_calc " placeholder="{{__('Grace Period')}} .." />
                            @if ($errors->has('grace_period'))
                            <div class="invalid-feedback">{{ $errors->first('grace_period') }}</div>
                            @endif
                        </div>
