...
<div class="row">
    ...
    <form action="{{ route('multipleRowsDelete', [$company, 'UploadExcel']) }}" method="POST">
        @csrf
        <x-table :tableTitle="__('Upload Excel Table')" :tableClass="'kt_table_with_no_pagination'" href="#" :importHref="route('uploadExcelImport',$company)" :exportHref="route('uploadExcels.export',$company)" :exportTableHref="route('table.fields.selection.view',[$company,'uploadExcel','upload_excels'])"
        :truncateHref="route('truncate',[$company,'UploadExcel'])">
            @slot('table_header')
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-12 ">
                    ...
                    <tr>
                        ...
                        <td class="kt-datatable__cell--left kt-datatable__cell " data-field="Actions" data-autohide-disabled="false">
                            <span class="d-flex justify-content-center" style="overflow: visible; position: relative; width: 110px;">
                                <form method="post"   action="{{route('uploadExcel.destroy',[$company,$item->id])}}" style="display: inline">
                                    @method('DELETE')
                                    @csrf
