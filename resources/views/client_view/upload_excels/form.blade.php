...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="kt-portlet">
            ...
            <!--begin::Form-->
            <form class="kt-form kt-form--label-right" method="POST" action={{(request()->is('*/edit'))  ? route('uploadExcel.update',[$company,$uploadExcel]): route('uploadExcel.store',[$company] )}}   enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="kt-input-icon">
                                    <input type="text" name="customer_name" value="{{$uploadExcel->customer_name}}" class="form-control" placeholder="{{__('Customer Name')}}">
