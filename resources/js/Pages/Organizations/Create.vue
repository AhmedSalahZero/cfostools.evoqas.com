      ...
      <div class="bg-mp-card border-b border-mp-border">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div>
            ...
            <h1 class="text-2xl font-bold text-white">Create New Organization</h1>
            <p class="text-white text-sm mt-1">Set up a consulting firm and assign its first administrator</p>
          </div>
        </div>
      </div>
        ...
        <form @submit.prevent="submit" class="space-y-8">
          ...
          <div class="bg-mp-card rounded-xl border border-mp-border p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="md:col-span-2">
                <label class="block text-xs font-semibold text-white uppercase tracking-widest mb-2">
                  Logo <span class="text-white font-normal normal-case tracking-normal">(optional)</span>
                </label>
                <div
                ...
                >
                  ...
                  <div v-else>
                    ...
                    <p class="text-white text-sm font-medium">Click to upload logo</p>
          ...
          <div class="bg-mp-card rounded-xl border border-mp-border p-6">
            ...
            <p class="text-white text-xs mb-6">This person will be the admin user for this organization</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="md:col-span-2">
                <label class="block text-xs font-semibold text-white uppercase tracking-widest mb-2">
                  Password <span class="text-mp-danger">*</span>
                </label>
                <div class="relative">
                  <input
          ...
          <div class="flex items-center justify-end gap-4 pb-8">
            ...
            >
              ...
              {{ form.processing ? 'Creating...' : 'Create Organization & Admin' }}
            </button>
          </div>
