<template>
  ...
  <AuthenticatedLayout>
    <div v-if="start" class="min-h-screen bg-mp-page text-white">
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div class="bg-mp-card border border-mp-border rounded-2xl p-6">
          ...
          <div v-if="!templates.length" class="border border-dashed border-mp-border rounded-xl p-8 text-center">
    ...
    <div v-else class="min-h-screen bg-mp-page text-white">
